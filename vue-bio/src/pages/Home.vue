  ...
  >
    <main class="flex justify-center items-center px-10 pt-24 pb-10">
      <div class="flex justify-between w-full max-w-4xl px-4">
        ...
        <div class="flex flex-col justify-center items-center text-center">
          <h1 class="text-6xl text-gray-50 pb-2 font-bold">Hello.</h1>
          <h2 class="text-4xl text-gray-50 pb-2 font-semibold">I'm Casey.</h2>
          <p class="text-2xl text-gray-50 pb-2 font-medium">A developer.</p>
        </div>
      </div>
    </main>
    <div
    ...
    >
      ...
      <p class="text-2xl text-gray-50 pb-4 font-medium">
        ...
        for creating intuitive, user-friendly web experiences. Based in
        Miami, I bring a unique background to web development — having previously
        worked as an educator and freelance musician in South Florida before
      ...
      <p class="text-2xl text-gray-50 pb-4 font-medium">
        ...
        projects, and code samples <a href="/portfolio" class="text-gray-50 underline hover:text-custom-purple hover:underline hover:underline-offset-2 hover:bg-transparent focus:bg-transparent focus:text-custom-purple focus:underline focus:underline-offset-2 focus:font-bold">here</a> to get a sense of what I can bring to your
        next web development project. I’m always eager to collaborate and create
        something unique!
      </p>
